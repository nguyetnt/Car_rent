            ...
            <div class="inner-w-signup">
                ...
                <form action={{ url("/signin") }} method="POST">
                    ...
                    <div style="width: 100%;">
                        ...
                        <input type="text" style="width: 100%; height: 50px; background-color: #d9d9d9" name="email">
                    </div>
                    <div style="width: 100%;">
                        <div style="margin-bottom: 8px;">Password</div>
                        <input type="password" style="width: 100%; height: 50px; background-color: #d9d9d9" name="password">
                    </div>
